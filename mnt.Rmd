...
## 1. Téléchargement du MNT via happign
...
## 2. Création des points éoliennes
...
## 4. Analyse comparative Roscoff vs Plougasnou

```{r comparaison}
# Reprojection des communes en SpatVector pour terra
roscoff <- zone_etude[zone_etude$nom_officiel == "Roscoff", ]
plougasnou <- zone_etude[zone_etude$nom_officiel == "Plougasnou", ]

# Conversion en SpatVector et reprojection
